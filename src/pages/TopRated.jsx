...
export default function TopRated() {
  ...
  const fetchRecommendations = async () => {
    const { data: { results } } = await axios.get(`${API_URL}movie/top_rated?api_key=ec16f51aa2aeb34f870ccabdaf00a523&language=en-US&${pages}`)
  ...
  return (
    <div>
      <TrendingDiv>
        ...
        <H2>TV</H2>
        <div className="recommendations">
          {recommendations2.slice(0, 18).map(recommendations2 => (
            <Recommendations
